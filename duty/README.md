...
(`duty create track <name>` creates one). Full docs: [../docs/](../docs/).
...
Filling in report prose, ticking gates honestly, and flagging doc bugs — if the code
must deviate from the docs under `docs/`, fix them in the same change.
