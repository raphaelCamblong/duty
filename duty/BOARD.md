...
- [cli/](cli/BOARD.md) — CLI
- [tui/](tui/BOARD.md) — TUI
...
| [T-23](T-23-cloudflare-pages-docs-hosting.md) | Cloudflare Pages docs hosting | blocked |
...
| [T-37](T-37-one-shot-forms-for-recurring-agent-seque.md) | One-shot forms for recurring agent sequences | done |
...
| [T-42](T-42-configurable-tui-theme-via-toml.md) | Configurable TUI theme via TOML | todo |
